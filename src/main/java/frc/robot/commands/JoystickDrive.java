...
public class JoystickDrive extends CommandBase {/*
  ...
  */
  ...
  public void execute() {
    ...
    double move = RobotContainer.joystick.getY(); //Forward/Backward movement -1 to 1
    double turn = RobotContainer.joystick.getZ(); //Left/Right rotation -1 to 1

    //if(RobotContainer.HalfSpeedButton.get()){
     //   move = move/2;
      //  turn = turn/2;
    //}
